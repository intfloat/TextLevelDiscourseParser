...
public class DependencyEvaluator {
	...
	while(goldInstance != null) {
	    ...
	    fileStr = fileStr.replaceAll(".prim", "");
	     ...
	     myWriter.write("This is detailed prediction result for both heads and labels, predicted head may be wrong.\n");
	    myWriter.write("EDU_ID goldHead predictionHead goldLabels predictionLabels\n");   	    
...
while(goldInstance != null) {
   ...
   fileStr = fileStr.replaceAll(".prim", "");
   fileStr = fileStr.replaceAll(".feat", "");
   myWriter.write("This is detailed prediction result assuming all heads are correctly predicted.\n");
   myWriter.write("EDU_ID goldHead predictionHead goldLabels predictionLabels\n");
   myWriter.write(fileStr+"\n");
